...
- **[API Documentation](backend/API.md)** - Полная документация REST API с примерами запросов и ответов
- **[ML API Documentation](backend/API.md#5-ml-api---утилиты-для-обучения-и-тестирования)** - Утилиты для обучения и тестирования ML модели
